...
silver_paths = [
    "abfss://0fa79899-c8de-4148-81cd-d17d4453fa56@onelake.dfs.fabric.microsoft.com/7c73dbc5-ec63-4226-b7da-6e0e0f90e731/Files/OpenAQ_data/OpenAQ_cleaned_tables/OpenAQ_Brooklyn_1",
    "abfss://0fa79899-c8de-4148-81cd-d17d4453fa56@onelake.dfs.fabric.microsoft.com/7c73dbc5-ec63-4226-b7da-6e0e0f90e731/Files/OpenAQ_data/OpenAQ_cleaned_tables/OpenAQ_Brooklyn_2"
]
...
final_df = final_df.rename(columns={col: f"{col}_Brooklyn" for col in final_df.columns if col != 'date'})

spark_final_df = spark.createDataFrame(final_df)
gold_output_path = "Files/OpenAQ_data_per_borough_gold/Brooklyn"
